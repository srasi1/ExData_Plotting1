...
plot4 <- function() {
	...
	png(filename="./figure/plot4.png", height=480, width=480)
	par(mfrow = c(2, 2))
	plot(hpcdata_dt$datetime, hpcdata_dt$Global_active_power/500, xlab = "", ylab = "Global Active Power", type = "l")
	plot(hpcdata_dt$datetime, (hpcdata_dt$Voltage/100)+226, xlab = "datetime", ylab = "Voltage", type = "l")
	plot(hpcdata_dt$datetime, hpcdata_dt$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
	...
	plot(hpcdata_dt$datetime, hpcdata_dt$Global_reactive_power/500, xlab = "datetime", ylab = "Global_rective_power", type = "l")
	dev.off()
}
