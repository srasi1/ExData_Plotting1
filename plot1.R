...
plot1 <- function() {
	...
	png(filename="./figure/plot1.png", height=480, width=480)
	hist(hpcdata_dt$Global_active_power/500, col="red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
	dev.off()
}
